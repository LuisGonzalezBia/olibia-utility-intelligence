...
export const registroDictEn: RegistroDictionary = {
  ...
  subtitle: 'Olibia Utility Intelligence is built for energy sector agents. Tell us who you are to get your market ranking.',
  fields: {
    nombre: 'First name',
    apellido: 'Last name',
    email: 'Work email',
    emailHint: 'Use your company email — we use it to verify you represent the agent.',
    password: 'Password',
    ...
    empresaOtraHint: 'Not a wholesale energy market agent — you can still use the platform.',
